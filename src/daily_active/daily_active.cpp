...
int main()
{
    RandomChoice rc({ "赞美帝皇", "血祭血神", "yesyes", "宣扬上上善道", "WAAAAAAAAAAGH" });
...
RandomChoice::RandomChoice(vector<string> strs)
{
    size = strs.size();
    arrow = 0;
